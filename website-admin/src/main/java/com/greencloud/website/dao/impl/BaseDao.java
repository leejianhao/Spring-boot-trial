...
public class BaseDao<T> implements IBaseDao<T>{
	...
	private final String path = "com.greencloud.website.db.mybatis.mapper.";
	private Class<?> clz;
	...
	public void add(T obj) {
		sqlSessionTemplate.insert(getMethodPath("save"), obj);
	}
	...
	public T load(Long id) {
		return sqlSessionTemplate.selectOne(getMethodPath("load"), id);
	}
	...
	public Pager<T> find(String sqlId, Map<String, Object> params) {
		...
		List<T> datas = sqlSessionTemplate.selectList(sqlId, params);
		pages.setDatas(datas);
		pages.setPageOffset(pageOffset);
		pages.setPageSize(pageSize);
		int totalRecord = (Integer)sqlSessionTemplate.selectOne(sqlId+"_count",params);
